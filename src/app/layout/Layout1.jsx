...
import SidenavTheme from "./SidenavTheme/SidenavTheme";
      ...
      <LayoutContainer width={sidenavWidth} secondarysidebar={secondarySidebar}>
        {layout1Settings.topbar.show && layout1Settings.topbar.fixed && (
          <ThemeProvider theme={topbarTheme}>
            <Layout1Topbar fixed={true} className="elevation-z8" {...props}/>
          </ThemeProvider>
        )}
        ...
        {!settings.perfectScrollbar && (
          <ContentBox>
            {layout1Settings.topbar.show && !layout1Settings.topbar.fixed && (
              <ThemeProvider theme={topbarTheme}>
                <Layout1Topbar
                  handleExitFullscreen={props.handleExitFullscreen}
