  ...
  const renderMobileMenu = (
    ...
    >
      <MenuItem>
        ...
        <p className="mt-3">Add Customer</p>
      </MenuItem>

      <MenuItem>
        <Link
          style={{ textDecoration: "none", color: "inherit" }}
          to={`/e-log/${organisationId}/customer/deleted`}
          className="d-flex"
        >
          <IconButton
            size="small"
          ...
          <p className="mt-3">Deleted Customers</p>
        </Link>
      </MenuItem>
    ...
    <div>
      ...
      >
        <Box>
          ...
          >
            <Link to={`/e-log/${organisationId}/customers`}>
              <IconButton
                size="small"
                onMouseEnter={() => setHover("group")}
                onMouseLeave={() => setHover()}
          ...
          <OverlayTrigger
            placement="bottom"
            overlay={<Tooltip>{"deleted customers"}</Tooltip>}
          >
            <Link to={`/e-log/${organisationId}/customers/deleted`}>
              <IconButton
                size="small"
                aria-label="deleted customers"
                onMouseEnter={() => setHover("preferences")}
                onMouseLeave={() => setHover()}
                color={hover === "preferences" ? "error" : "primary"}
              >
