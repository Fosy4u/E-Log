...
import DeleteCustomerRemarkModal from "./DeleteCustomerRemarkModal";
import { globalSelectors } from "../../../global/global.slice";
import displayDate from "../../../utils/displayDate";
import Loader from "../../../utils/Loader";

const CustomerRemarks = ({ customer, isLoading }) => {
  ...
  const getCustomerRemarksQuery = organisationsApi.useGetCustomerRemarkQuery(
    {
      _id: customer?._id,
    },
    { skip: !customer?._id || !token }
  );
  const remarks = getCustomerRemarksQuery?.data?.data;

  const [addRemark, addRemarkStatus] =
    organisationsApi.useAddCustomerRemarkMutation();

  const [editPartnerRemark, editPartnerRemarkStatus] =
    organisationsApi.useEditCustomerRemarkMutation();
    ...
    >
      <Loader
        showLoading={
          ...
          getCustomerRemarksQuery?.isLoading ||
